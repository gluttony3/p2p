...
try:
    ...
    data = {"nickname": "", "messages": []} # создает словарь и список
...
window.title("ЧАТ")
icon = tk.PhotoImage(file="comments.png")
...
nick_entry.place(relx=0.5, rely=0.5, anchor="center")
    ...
    # Вставляем сохранённый ник при запуске
if data.get("nickname"):
    nick_entry.insert(0, data["nickname"])
...
def show_chat():
    ...
    chat_ready = CTkTextbox(chat_frame, height=290, width=340, 
